              ...
              <details className="rounded-lg border border-gray-200 bg-gray-50 p-3">
                ...
                <ul className="mt-2 list-disc list-inside space-y-1 text-sm text-gray-600">
                  ...
                  <li>To get the Cook County PIN: search by address at{" "}
                    <a href="https://www.cookcountyassessoril.gov/address-search" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">cookcountyassessoril.gov/address-search</a> — PIN is required for the county form.</li>
