...
/**
 * This route serves both the neutral-report and legacy commerce postures.
 * Keep shared metadata product-neutral so search and social previews remain
 * accurate regardless of the server-side commerce flag used for the body.
 */
