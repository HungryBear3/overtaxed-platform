...
The DB-backed transaction
exercises checkout/payment binding, QA and ZIP promotion, fulfillment and
delivery capability issuance, a one-use download, reversal/refund convergence,
and restricted-role/RLS behavior using synthetic values. No external write
adapter is present.
