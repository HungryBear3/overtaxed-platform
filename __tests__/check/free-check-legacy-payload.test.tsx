...
describe("a supplied disclosure is checked, not trusted", () => {
  const OUTCOMES: Record<string, ResultOutcome> = {
    ...
    B: { code: "not_supportive", headline: CC_04, allowCheckout: false, showFigures: true, showRecordComparison: true, reason: null },
    C: { code: "insufficient_evidence", headline: CC_05, allowCheckout: false, showFigures: false, showRecordComparison: false, reason: null },
    D: { code: "unsupported_property", headline: CC_06, allowCheckout: false, showFigures: false, showRecordComparison: false, reason: null },
  }
